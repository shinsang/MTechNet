...
<%
	System.out.println("----------user_contents_reference start -----------");
	...
	try {
		Class.forName(driverName);
	 	...
	 	String sql = "SELECT count(*) FROM CONTENTS_INFO WHERE CONTENTS_REFRENCE_USER_ID="+userId
		...
		System.out.println("-------user_contents_reference end -------");
